...
background_image = pygame.image.load("2.jpg")  # Replace "background.jpg" with your image file
...
def game_over(player_score, ai_score):
    ...
    game_over_background = pygame.image.load("3.jpg")  # Replace "game_over_background.jpg" with your image file
